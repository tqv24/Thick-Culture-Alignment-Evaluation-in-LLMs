    ...
    def get_instances(self, output_path: str) -> List[Instance]:
        ...
        for item in dataset:
            ...
            input_text = (
                ...
                Then explain your reasoning in 2–4 sentences, making sure to identify and explain the relevant cultural norm, value, or practice that applied to the situation.
